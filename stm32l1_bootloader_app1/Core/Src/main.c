...
int main(void)
{
  ...
  // struct BootloaderSharedAPI *api  : icinde fonksiyon pointerlari olan bir tablo (pointer)
  // adresi de atarken pointer casting yapıyor (struct BootloaderSharedAPI*) 0x8018000;
  // hizalama mevzularından dolayi
